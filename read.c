//создает строку с информации о каждом файле в директории и отправляет их (каждую строку отдельно, после того, как была считана предыдущая строка) в файл типа mmap(mmaped.dat)
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <fcntl.h>
